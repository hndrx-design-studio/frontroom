...
(function () {
  ...
  window.addEventListener('popstate', function () {
    ...
    // hold the nav. Back/forward should behave like an ordinary link, not a
    // footer link, so the navbar must not roll down from the top.
    go(location.href, true, false, false);
  });
